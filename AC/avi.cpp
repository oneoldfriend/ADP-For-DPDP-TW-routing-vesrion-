...
void AVI::approximation(ValueFunction *valueFunction)
{
    ...
    while (totalSimulationCount < MAX_SIMULATION)
    {
        ...
        {
            valueFunction->criticUpdate(routingValueAtThisSimulation, assignmentValueAtThisSimulation, true);
        }
        else
        {
            valueFunction->criticUpdate(routingValueAtThisSimulation, assignmentValueAtThisSimulation, false);
        }
        valueFunction->actorUpdate(routingReplayBuffer, assignmentReplayBuffer);
